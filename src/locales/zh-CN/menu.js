export default {
  ...
  'menu.system': '系统设置',
  'menu.system.index-setting': '首页设置',
  'menu.system.menus': '菜单管理',
  'menu.system.permission': '权限管理',
  'menu.system.role': '角色管理',
  'menu.system.user': '用户管理',
  'menu.org': '组织架构',
  'menu.org.organizational': '机构管理',
  'menu.org.manager': '综合设置',
  'menu.org.person': '人员管理',
  'menu.develop': '开发人员工具',
  'menu.develop.code-generator': '代码生成器',
  'menu.develop.dynamic-form': '动态表单',
  'menu.develop.template': '模版管理',
  'menu.develop.schedule': '定时任务'
};
